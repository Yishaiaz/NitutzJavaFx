...
public class View implements Observer {
    ...
    public void postFlightPressed(){
        ...
        TextField txt_depDate = new TextField();
        TextField txt_arrDate = new TextField();
        ...
        TextField txt_returnFlight = new TextField();
        ...
        grid.add(txt_depDate, 2, 3);
        grid.add(lbl_arrDate, 1, 4);
        grid.add(txt_arrDate, 2, 4);
